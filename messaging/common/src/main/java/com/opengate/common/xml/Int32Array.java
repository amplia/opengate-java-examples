 ...
 *       &lt;sequence>
 *         &lt;element name="int32List" maxOccurs="unbounded">
 *           &lt;complexType>
 *             &lt;simpleContent>
...
@XmlRootElement(name = "int32Array")
public class Int32Array {

    @XmlElement(required = true)
    protected List<Int32Array.Int32List> int32List;
     ...
     * {@link Int32Array.Int32List }
     * 
     * 
     */
    public List<Int32Array.Int32List> getInt32List() {
        if (int32List == null) {
            int32List = new ArrayList<Int32Array.Int32List>();
        }
